newspaper.factory('BeatsFactory', function BeatsFactory(ReportersFactory, UtilitiesFactory) {
  var factory = {};
  factory.beats = [];
  factory.Beat = {};
  factory.ReportersFactory = ReportersFactory
  factory.reporters = ReportersFactory.reporters
  ...
  factory.Beat.addReporterbyId = function(reporterId) {
    reporter = UtilitiesFactory.findById(ReportersFactory.reporters, reporterId);
    this.reporters.push(reporter);
  }
